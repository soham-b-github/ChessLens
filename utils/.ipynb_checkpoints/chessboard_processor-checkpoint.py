...
def cut_chessboard(img, output_path="boxes", output_prefix="box"):
    side_len = int(img.shape[0] / 8)
    for i in range(8):
        for j in range(8):
            row_ind1 = i * side_len
            row_ind2 = (i+1) * side_len

            col_ind1 = j * side_len
            col_ind2 = (j+1) * side_len
...
def process_chessboard(src_path, output_path, output_prefix="", debug=False):
    ...
    if debug:
        ...
        cv2.imwrite('results/grayscale.png', process)
        cv2.waitKey()
    ...
    if debug:
        ...
        cv2.imwrite('results/blur.png', process)
        cv2.waitKey()
    ...
    if debug:
        ...
        cv2.imwrite('results/canny.png', process)
        cv2.waitKey()
    ...
    if debug:
        ...
        cv2.imwrite('results/dilate.png', process)
        cv2.waitKey()
    ...
    if debug:
        ...
        cv2.imwrite('results/sorted-lines.png', src_copy)
        cv2.waitKey()
    ...
    if debug:
        ...
        cv2.imwrite('results/intersections.png', src_copy)
        cv2.waitKey()
    ...
    if debug:
        ...
        cv2.imwrite('results/clustered-intersections.png', src_copy)
        cv2.waitKey()
    ...
    if debug:
        ...
        cv2.imwrite('results/corners.png', src_copy)
        cv2.waitKey()
    ...
    if debug:
        ...
        cv2.imwrite('results/warped.png', dst)
        cv2.waitKey()
